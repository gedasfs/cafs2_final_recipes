...
@elseif (isset($recipe))
        @foreach ($recipe->ingredients as $ingredient)
            <div class="row justify-content-between align-items-center mb-3 mb-md-0 ms-2 line">
                ...
                <div class="col-12 col-md-5">
                    <x-cmn.floating-input type="text" name="ingredient_name[]" value="{{ $ingredient->name }}" required>Ingredientas</x-cmn.floating-input>
                </div>
                <div class="col-12 col-md-3">
                    <x-cmn.floating-input type="text" name="ingredient_quantity[]" value="{{ $ingredient->quantity }}" required>Kiekis</x-cmn.floating-input>
                </div>
                <div class="col-12 col-md-3">
                    <x-cmn.floating-input type="text" name="ingredient_unit[]" value="{{ $ingredient->unit }}" required>Vienetas</x-cmn.floating-input>
                </div>
                <div class="col-12 col-md-1 text-end">
                    <x-cmn.btn outlined color="secondary" class="px-3 py-2 mb-3" data-btn="removeLine">x</x-cmn.btn>
                </div>
...
@else
    <div class="row justify-content-between align-items-center mb-3 mb-md-0 ms-2 line">
        ...
        <div class="col-12 col-md-5">
            <x-cmn.floating-input type="text" name="ingredient_name[]" required>Ingredientas</x-cmn.floating-input>
        </div>
        <div class="col-12 col-md-3">
            <x-cmn.floating-input type="text" name="ingredient_quantity[]" required>Kiekis</x-cmn.floating-input>
        </div>
        <div class="col-12 col-md-3">
            <x-cmn.floating-input type="text" name="ingredient_unit[]" required>Vienetas</x-cmn.floating-input>
        </div>
        <div class="col-12 col-md-1 text-end">
            <x-cmn.btn outlined color="secondary" class="px-3 py-2 mb-3" data-btn="removeLine">x</x-cmn.btn>
        </div>
